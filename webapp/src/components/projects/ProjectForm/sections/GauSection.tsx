      ...
      {isOpen && (
        <div className={styles.sectionContent}>
          <p className={styles.sectionDescription}>
            使用 GetAllUrls（GAU）进行被动 URL 发现：在不直接触碰目标的情况下，从 Web 归档与威胁情报来源获取历史 URL。可用归档数据补充 Katana 的主动爬取结果。
            GAU 不需要任何 API Key。若希望在 URLScan 获得更高的速率限制与更多结果，可在 <strong>设置 &gt; 工具 API Keys</strong> 中配置 URLScan API Key。
          </p>
            ...
            <>
              ...
              <div className={styles.fieldRow}>
                <div className={styles.fieldGroup}>
                  ...
                  <input
                    ...
                    min={1}
                  />
                  <span className={styles.fieldHint}>每个域名最多获取的 URL 数（0 = 不限）</span>
                </div>
                <div className={styles.fieldGroup}>
              ...
              <div className={styles.fieldRow}>
                <div className={styles.fieldGroup}>
                  ...
                  <input
                    ...
                    max={20}
                  />
                  <span className={styles.fieldHint}>并行抓取线程数</span>
                </div>
                <div className={styles.fieldGroup}>
                  ...
                  <input
                    ...
                    max={20}
                  />
                  <span className={styles.fieldHint}>并行域名查询 worker 数</span>
                </div>
              </div>
              ...
              <div className={styles.toggleRow}>
                <div>
                  ...
                  <p className={styles.toggleDescription}>启用更详细的日志以便调试</p>
                </div>
                <Toggle
              ...
              <div className={styles.subSection}>
                ...
                <div className={styles.fieldGroup}>
                  ...
                  <span className={styles.fieldHint}>跳过图片、字体、文档等静态资源</span>
                </div>
              </div>
              ...
              <div className={styles.subSection}>
                ...
                <div className={styles.toggleRow}>
                  <div>
                    <span className={styles.toggleLabel}>校验 URL</span>
                    <p className={styles.toggleDescription}>通过 HTTP 检查确认归档 URL 是否仍然可用，并过滤死链</p>
                    <TimeEstimate estimate="耗时可能增加 2-3 倍" />
                  </div>
                  <Toggle
                ...
                {data.gauVerifyUrls && (
                  <>
                    <div className={styles.fieldRow}>
                      <div className={styles.fieldGroup}>
                        <label className={styles.fieldLabel}>校验超时</label>
                        <input
                          type="number"
                          className="textInput"
                      ...
                      <div className={styles.fieldGroup}>
                        <label className={styles.fieldLabel}>校验速率限制</label>
                        <input
                          type="number"
                          className="textInput"
                    ...
                    <div className={styles.fieldRow}>
                      <div className={styles.fieldGroup}>
                        ...
                        <input
                          ...
                          max={100}
                        />
                        <span className={styles.fieldHint}>并发校验线程数</span>
                      </div>
                      <div className={styles.fieldGroup}>
                        <label className={styles.fieldLabel}>校验 Docker 镜像</label>
                        <input
                          type="text"
                          className="textInput"
                    ...
                    <div className={styles.fieldGroup}>
                      <label className={styles.fieldLabel}>接受的状态码</label>
                      <div className={styles.fileImportWrap}>
                        <input
                          type="text"
                          className="textInput"
                      ...
                      <span className={styles.fieldHint}>表示 URL 存活的状态码。对需要鉴权的端点可包含 401/403</span>
                    </div>
                    ...
                    <div className={styles.toggleRow}>
                      <div>
                        ...
                        <TimeEstimate estimate="在校验耗时基础上再增加约 30-50%" />
                      </div>
                      <Toggle
                    ...
                    <div className={styles.toggleRow}>
                      <div>
                        ...
                        <p className={styles.toggleDescription}>从最终结果中剔除返回 404/500/超时 的 URL</p>
                      </div>
                      <Toggle
