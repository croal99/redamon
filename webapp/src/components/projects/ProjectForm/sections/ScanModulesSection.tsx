...
const SCAN_MODULE_OPTIONS = [
  { id: 'domain_discovery', label: '发现与 OSINT', description: '子域名枚举、Shodan、URLScan', indent: 0 },
      ...
      {isOpen && (
        <div className={styles.sectionContent}>
          <p className={styles.sectionDescription}>
            通过启用或禁用特定模块来控制侦察流水线。每个模块都会基于其父模块的结果继续构建，从域名发现到漏洞检测逐步形成完整的攻击面图谱。
          </p>
          ...
          <div className={styles.subSection}>
            ...
            <div className={styles.toggleRow}>
              <div>
                <span className={styles.toggleLabel}>侦察使用 Tor</span>
                <p className={styles.toggleDescription}>
                  将侦察流量通过 Tor 网络转发
                </p>
              </div>
