...
const FORBIDDEN_CATEGORIES = [
  { value: 'brute_force', label: '凭证测试' },
  { value: 'dos', label: '可用性/压测类测试' },
  { value: 'social_engineering', label: '社会工程' },
  { value: 'physical', label: '物理接触' },
]

const DATA_HANDLING_OPTIONS = [
  { value: 'no_access', label: '不接触敏感数据' },
  ...
  return (
        ...
        <div className={styles.sectionContent}>
          ...
          {mode === 'create' && (
            <div className={styles.subSection}>
              ...
              <p className={styles.sectionDescription}>
                ...
                解析后的规则会同时对 <strong>侦察流水线</strong>（排除主机、限速、时间窗口）与 <strong>Agentic AI 活动</strong>（工具限制、阶段上限、提示词级指令）施加护栏约束。
              </p>
            ...
            <div className={styles.fieldRow}>
              <div className={styles.fieldGroup}>
                ...
                <Toggle
                  ...
                  disabled={readOnly}
                />
                <span className={styles.fieldHint}>启用后，RoE 约束将同时作用于 Agent 与侦察流水线。</span>
              </div>
            </div>
          </div>
          ...
          {data.roeEnabled && (
            <>
              {/* Client & Engagement */}
              <div className={styles.subSection}>
                <h3 className={styles.subSectionTitle}>客户与项目</h3>
                <div className={styles.fieldRow}>
                  <div className={styles.fieldGroup}>
                  ...
                  <div className={styles.fieldGroup}>
                    <label className={styles.fieldLabel}>项目类型</label>
                ...
                <div className={styles.fieldRow}>
                  ...
                  <div className={styles.fieldGroup}>
                    <label className={styles.fieldLabel}>联系人电话</label>
              ...
              <div className={styles.subSection}>
                ...
                <p className={styles.sectionDescription}>绝对禁止扫描或测试的 IP 或域名。</p>
                  ...
                  <div key={i} className={styles.fieldRow} style={{ alignItems: 'flex-end' }}>
                    ...
                    <div className={styles.fieldGroup} style={{ flex: 1 }}>
                      ...
                      <input className="textInput" value={(data.roeExcludedHostReasons || [])[i] || ''} readOnly={readOnly}
                        onChange={(e) => updateExcludedReason(i, e.target.value)} placeholder="为何排除" />
                    </div>
                    {!readOnly && (
              ...
              <div className={styles.subSection}>
                ...
                <div className={styles.fieldRow}>
                  <div className={styles.fieldGroup}>
                    <label className={styles.fieldLabel}>将测试限制在指定时间窗口内</label>
                    <Toggle
                ...
                {data.roeTimeWindowEnabled && (
                  <>
                    ...
                    <div className={styles.fieldRow}>
                      <div className={styles.fieldGroup}>
                        <label className={styles.fieldLabel}>允许的日期</label>
              ...
              {/* Testing Permissions */}
              <div className={styles.subSection}>
                <h3 className={styles.subSectionTitle}>测试权限</h3>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                  <div className={styles.fieldGroup}>
                    <label className={styles.fieldLabel}>允许可用性/压测类测试</label>
                  ...
                  <div className={styles.fieldGroup}>
                    <label className={styles.fieldLabel}>允许物理接触</label>
                  ...
                  <div className={styles.fieldGroup}>
                    <label className={styles.fieldLabel}>允许在生产环境测试</label>
              ...
              <div className={styles.subSection}>
                <h3 className={styles.subSectionTitle}>禁止技术/手段</h3>
                <p style={{ fontSize: '0.8rem', color: '#888', margin: '0 0 8px 0' }}>
                  工具级限制请在「Tool Matrix」页的 Tool Phase Restrictions 中配置。
                </p>
                <div className={styles.fieldRow}>
                  <div className={styles.fieldGroup}>
              ...
              <div className={styles.subSection}>
                ...
                <div className={styles.fieldRow}>
                  ...
                  <div className={styles.fieldGroup}>
                    ...
                    <span className={styles.fieldHint}>0 表示不限制；会对所有工具的速率上限生效。</span>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.subSection}>
                ...
                <div className={styles.fieldRow}>
                  <div className={styles.fieldGroup}>
                    <label className={styles.fieldLabel}>要求数据加密</label>
              ...
              <div className={styles.subSection}>
                ...
                <div className={styles.fieldRow}>
                  <div className={styles.fieldGroup}>
                    ...
                    <select className="select" value={data.roeStatusUpdateFrequency} disabled={readOnly}
                      ...
                      <option value="on_finding">每个发现</option>
                      <option value="none">不更新</option>
                    </select>
                  </div>
                  <div className={styles.fieldGroup}>
                    <label className={styles.fieldLabel}>发现严重问题时通知客户</label>
                ...
                <div className={styles.fieldRow}>
                  <div className={styles.fieldGroup}>
                    <label className={styles.fieldLabel}>事故处理流程</label>
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', fontSize: '0.9rem', lineHeight: 1.6 }}>
        ...
        <p style={{ margin: 0 }}>
          以下标签页可能已根据解析结果发生变化，请在保存前检查确认：
        </p>

        <ul style={{ margin: 0, paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '6px' }}>
          <li><strong>Target &amp; Modules</strong> — 目标域名、IP 地址、扫描模块、限速</li>
          <li><strong>Tool Matrix</strong> — Tool Phase Restrictions（被禁用的工具会在矩阵中关闭）</li>
          <li><strong>Rules of Engagement</strong> — 排除主机、时间窗口、测试权限、合规</li>
        </ul>
        ...
        <p style={{ margin: 0, padding: '10px 12px', background: 'var(--color-surface-alt, rgba(59,130,246,0.08))', borderRadius: '6px', borderLeft: '3px solid var(--color-accent, #3b82f6)' }}>
          交战规则（RoE）会同时作用于 <strong>侦察流水线</strong>（主机排除、限速、时间窗口）与 <strong>Agentic AI</strong>（工具限制、阶段上限、提示词指令）。
        </p>
      </div>
    </Modal>
    </>
