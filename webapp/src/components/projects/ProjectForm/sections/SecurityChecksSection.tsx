      ...
      {isOpen && (
        <div className={styles.sectionContent}>
          <p className={styles.sectionDescription}>
            对已发现的结果执行自定义安全验证检查。包括安全响应头分析、SSL/TLS 配置审查，以及其他自动化安全评估，用于验证并补充漏洞上下文。
          </p>
          ...
          {data.securityCheckEnabled && (
            <>
              <div className={styles.fieldRow}>
                ...
                <div className={styles.fieldGroup}>
                  <label className={styles.fieldLabel}>最大并发数</label>
                  <input
                    type="number"
                    className="textInput"
              ...
              <div className={styles.subSection}>
                ...
                <div className={styles.toggleRow}>
                  <span className={styles.toggleLabel}>检查直接 IP HTTP</span>
                  <Toggle
                ...
                <div className={styles.toggleRow}>
                  <span className={styles.toggleLabel}>检查直接 IP HTTPS</span>
                  <Toggle
                ...
                <div className={styles.toggleRow} style={{ alignItems: 'center', gap: 'var(--space-4)' }}>
                  <AiToggleLabel
                    label="使用 AI 进行 WAF 识别"
                    tooltip={
                      '增强静态 WAF/CDN 头部 token 检测。当静态列表漏检（现代 WAF ' +
                      '可能会移除或重塑其头部标识）时，会将响应再次交由已配置的模型分析，' +
                      '基于 headers、body 指纹、cookies 与延迟对 WAF 存在性打分 0-100。' +
                      'AI 检测到的绕过会标记 detection_method=ai_classifier、waf_type、waf_confidence。' +
                      (!data.aiInPipeline ? '要启用此功能，请先在 Target 页开启「AI in Pipeline」。' : '')
                    }
                  />
                  <Toggle
              ...
              <div className={styles.subSection}>
                ...
                <div className={styles.toggleRow}>
                  <span className={styles.toggleLabel}>会话 Cookie 缺少 Secure</span>
                  <Toggle
                ...
                <div className={styles.toggleRow}>
                  <span className={styles.toggleLabel}>会话 Cookie 缺少 HttpOnly</span>
                  <Toggle
              ...
              <div className={styles.subSection}>
                ...
                <div className={styles.toggleRow}>
                  <span className={styles.toggleLabel}>开启区域传送（AXFR）</span>
                  <Toggle
              ...
              <div className={styles.subSection}>
                <h3 className={styles.subSectionTitle}>暴露服务</h3>
                <div className={styles.toggleRow}>
                ...
                <div className={styles.toggleRow}>
                  <span className={styles.toggleLabel}>Redis 未启用认证</span>
                  <Toggle
              ...
              <div className={styles.subSection}>
                ...
                <div className={styles.toggleRow}>
                  <span className={styles.toggleLabel}>表单 action 不安全</span>
                  <Toggle
                ...
                <div className={styles.toggleRow}>
                  <span className={styles.toggleLabel}>缺少限流</span>
                  <Toggle
